...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            if hasattr(self.ant, 'container') and self.ant.container and isinstance(self.ant.ant, QueenAnt) and self.ant.ant.true_queen:
                return
            if isinstance(self.ant, QueenAnt) and self.ant.true_queen:
                return
...
class Bee(Insect):
    ...
    def blocked(self):
        ...
        # BEGIN Problem 8
        return self.place.ant and self.place.ant and self.place.ant.blocks_path
        # END Problem 8
...
class BodyguardAnt(Ant):
    ...
    name = 'Bodyguard'
    # BEGIN Problem 11
    implemented = True   # Change to True to see in GUI
    food_cost = 4
    container = True
    # END Problem 11
...
# BEGIN Problem 13
class QueenAnt(ScubaThrower):  # You should change this line: done
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.true_queen:
            ...
            while current_place is not None and current_place.exit is not None:
                ant_1 = current_place.ant
                if ant_1 is not None:
                    if hasattr(ant_1, 'container') and ant_1.container and ant_1.ant is not None:
                        if ant_1.ant not in self.lethal_ants:
                            ant_1.ant.damage *= 2
                            self.lethal_ants.append(ant_1.ant)
                    else:
                        if ant_1 not in self.lethal_ants:
                            ant_1.damage *= 2
                            self.lethal_ants.append(ant_1)    
...
def apply_effect(effect, bee, duration):
    ...
    # BEGIN Problem EC
    original = bee.action
    affect = effect(original)
    
    def affect_action(colony):
        nonlocal duration
        if duration > 0:
            affect(colony)
        else:
